...
@section('breadcrumb')
    <a href="{{ route('manager.invoices.index') }}">Factures</a> / Nouvelle
@endsection

@section('content')
<form method="POST" action="{{ route('manager.invoices.store') }}" id="doc-form">
    @csrf
            ...
            <div class="card-body">
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="marche_number" value="{{ old('marche_number') }}" placeholder="Numéro de marché">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group">
                ...
                <div class="form-group">
                    <label>Objet</label>
                    <input type="text" name="subject" value="{{ old('subject') }}" placeholder="Objet de la facture">
                </div>
                <div class="form-row">
                    <div class="form-group">
    ...
    <div class="form-actions mt-4">
        <a href="{{ route('manager.invoices.index') }}" class="btn-secondary">Annuler</a>
