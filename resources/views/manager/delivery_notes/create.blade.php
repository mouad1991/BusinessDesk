...
@section('breadcrumb')
    <a href="{{ route('manager.delivery-notes.index') }}">Bons de livraison</a> / Nouveau
@endsection

@section('content')
<form method="POST" action="{{ route('manager.delivery-notes.store') }}" id="doc-form">
    @csrf
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="order_reference" value="{{ old('order_reference') }}" placeholder="Numéro de commande">
                </div>
                <div class="form-group">
                    <label>Adresse de livraison</label>
                    <textarea name="delivery_address" rows="2" placeholder="Adresse de livraison (si différente)">{{ old('delivery_address') }}</textarea>
                </div>
                <div class="form-group">
    ...
    <div class="card mt-4">
        ...
        <div class="card-body">
            <div class="form-group">
                ...
                <textarea name="notes" rows="3" placeholder="Ex : Instructions de livraison, mention particulière, remarque...">{{ old('notes') }}</textarea>
            </div>
        </div>
    </div>

    <div class="form-actions mt-4">
        <a href="{{ route('manager.delivery-notes.index') }}" class="btn-secondary">Annuler</a>
